...
-   `dials::grid_regular()` : create an expanded grid based on a combination of two hyperparameters
-   set the grid up manually using a one-column tibble with 30 candidate values
...
![Strategies for mitigating bias across the different steps in machine learning systems development](mitigating_bias.png)
